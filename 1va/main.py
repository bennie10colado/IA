...
class VacuumCleanerEnvironment:
    ...
    # temos 2 espaços em que o aspirador se move, mas podemos aumentar o eixo y para que se tenha mais colunas,
...
if __name__ == "__main__":
    random.seed(0)  # Garante a reprodutibilidade dos resultados.
